  ...
  <div class="content-index">
    <article class="main-content page-page">
      <div class="post-header">
        ...
        <div class="post-data">
          <time datetime="" itemprop="datePublished">{{article.firstPublishTime}}</time>
          in
          <a href="#">{{article.notebookName}}</a>
           visits <span> {{article.pageVisitor}} </span>
        </div>
      </div>
      <div class="post-content" itemprop="articleBody">
        ...
        <div id="post-content" v-html="article.contentHtml" ref="content"></div>
        ...
        <p class="post-info">
          ...
          国际许可协议进行许可<br>本站文章除注明转载/出处外，均为本站原创或翻译，转载前请务必署名<br>最后编辑时间为: {{article.latestEditTime}}
        </p>
      </div>
    </article>
...
<script>
    ...
    import { findById, getPublishedOfNoteByNoteId } from '@/api/article'
    ...
    export default {
        ...
        methods: {
            fetchData() {
                ...
                // })
                getPublishedOfNoteByNoteId(this.$route.params.id)
                    .then(response => {
